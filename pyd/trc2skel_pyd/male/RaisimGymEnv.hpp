...
class RaisimGymEnv {
 ...
 public:
  ...
  virtual void build(const Eigen::Ref<EigenRowMajorMat>& trc, const std::vector<std::string>& markers, const Eigen::Ref<Eigen::VectorXi>& indices, const Eigen::Ref<EigenVec>& betas, const Eigen::MatrixXi& f) = 0;
