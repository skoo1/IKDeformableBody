...
env.build(np.zeros([100, 3], dtype=np.float32), np.zeros([100, 3], dtype='<U32'), np.zeros([100], dtype=np.int), np.zeros([100], dtype=np.double64), np.zeros([100, 3], dtype=np.int))


obs = env.observe(False)
reward, dones = env.step(np.zeros([10,75]))
